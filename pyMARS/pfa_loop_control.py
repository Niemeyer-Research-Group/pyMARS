...
from pfa import trim_pfa
import os
from numpy import genfromtxt
import numpy as np

def pfa_loop_control(solution_object, args, stored_error, threshold, done, rate_edge_data):
    ...
    drgep = trim_pfa(rate_edge_data, solution_object, threshold, args.keepers, done,target_species) #Find out what to cut from the model
