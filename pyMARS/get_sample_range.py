...
def get_range(times, temps, sdata, production_data):
    ...
    try:
        ...
        print 'total timesteps: %s' % len(T)
    class sample_data:
        def __init__(self, tau, index, times, temps, species_data, production_data, derivative_max, initial_point, final_point):
            self.tau = tau
            self.index = index
    ...
    return sample_data(tau, index, times, temps, species_data, production_data, derivative_max, initial_point, final_point)
