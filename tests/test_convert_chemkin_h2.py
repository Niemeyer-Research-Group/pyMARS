"""Tests the convert_chemkin_file using LNLL h2 mechanism files

Chemkin mechanism, thermo and transport data files are imported to
the input folder and convert_chemkin_file is called.

Complete Cantera mechanism file is left in output folder"""

"""Note: this test can be run from py.test, or independently"""
