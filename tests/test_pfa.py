...
class TestCreatePFAMatrix:
    ...
    def test_qss_artificial(self):
        ...
        mass_fracs = [1.0, 1.0 / 1.0e3, 0.0, 0.0]
...
class TestReducePFA:
    def test_gri_reduction_multiple_thresholds(self):
        ...
        assert round(reduced_model.error, 2) == 0.14
...
class TestRunPFA:
    def test_gri_reduction(self):
        ...
        expected_model = ct.Solution(
            relative_location(os.path.join("assets", "pfa_gri30.yaml"))
        )
