...
#read in solution file, and make constant volume adiabatic reactor
solution2 = ct.Solution('gri30.cti', reactions="all", transport="Multi")  #trimmed_h2_v1b_mech.cti
solution2.TP = 1001.5, ct.one_atm
r2 = ct.Reactor(solution2)
sim2 = ct.ReactorNet([r2])

time2= 0.0#initial_point[0]*10e-4 #initial_point[0]
